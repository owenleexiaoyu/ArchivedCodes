...
public class StepDetector implements SensorEventListener {
    ...
    private float mLimit =(float)8.12;  //6.5-7之间
    ...
    private StepCountListener mCountListener;
    ...
    public void setStepCountListener(StepCountListener s){
        mCountListener = s;
    }
