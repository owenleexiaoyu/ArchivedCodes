...
public class RegistCheckcodeFragment extends Fragment implements View.OnClickListener {
        ...
        public void afterEvent(int event, int result, Object data) {
            ...
            if (result == SMSSDK.RESULT_COMPLETE) {
                ...
                if (event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE) {
                    //提交验证码成功
                    Logging.i(TAG, "afterEvent: ----------------------验证成功了---------------");
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    ...
                    Fragment passFragment = new RegistPassFragment();
